...
namespace Baran.Windows.Forms
{
    ...
    public class UltraMaskedDate : Infragistics.Win.UltraWinMaskedEdit.UltraMaskedEdit
    {
        public UltraMaskedDate()
        {
            ...
            this.EditAs = Infragistics.Win.UltraWinMaskedEdit.EditAsType.UseSpecifiedMask;
