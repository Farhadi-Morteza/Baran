...
namespace Demo.WindowsForms
{
    ...
    public class Map : GMapControl
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            MapProvider = BingHybridMapProvider.Instance;//BingSatelliteMapProvider.Instance;//GoogleHybridMapProvider.Instance;//GoogleHybridMapProvider.Instance;//    GoogleHybridMapProvider.Instance;// 
