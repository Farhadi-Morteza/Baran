...
namespace Baran.Classes.Common
{
    ...
    public static class UpdateSoftwareInfo
    {
        ...
        public static readonly string ConfirmMessage = $"نرم افزار بایستی بروز رسانی شود!  با توجه به اینکه نرم افزار برای بروز رسانی به ftp متصل می شود، ممکن است کمی زمان ببرد!  لطفا صبور باشید  آیا برنامه بروزرسانی شود؟";
